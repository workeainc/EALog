...
type View = "overview" | "reports" | "sessions" | "settings";
type SyncState = {
    online: boolean;
    pending: number;
    failed: number;
...
export default function App() {
        ...
        (async () => {
            try {
                ...
                if (!user) {
                    ...
                    setSyncError(
                        "Sign in with Google to open your synced workspace.",
                    );
                    return;
                ...
                offActive = service.subscribeToActiveSession(
                    ...
                    (active: any) => {
                        ...
                        setAccumulatedSeconds(
                            Math.max(
                                0,
                                Number(active?.accumulatedSeconds) || 0,
                            ),
                        );
                        setStartedAt(
                            active
                ...
                if (!disposed)
                    setSyncError(
                        error?.message || "Firebase sync could not start.",
                    );
                setDataLoading(false);
            }
        })();
        ...
        const logs =
            activityPeriod === "daily"
                ...
                : activityPeriod === "weekly"
                  ? weekLogs
                  : monthLogs;
        const aggregate = aggregateReportRows(
            normalizeReportLogs(logs),
            timezone,
        );
    ...
    const addProject = async () => {
        ...
        if (!Number.isFinite(targetMinutes) || targetMinutes < 1)
            return setAddProjectError(
                "Enter a daily target of at least 1 minute.",
            );
    ...
    const profileName =
        profile?.displayName || authUser?.displayName || "Admin";
                ...
                {view === "reports" ? (
                    ...
                    <ProfileSettings
                        ...
                        onSave={async (input) => {
                            ...
                            const next = await tracker.updateProfile(
                                uid,
                                input,
                            );
                            setProfile(next);
                    ...
                    <>
                        <section className="hero-row">
                            <div>
                                ...
                                <p className="muted">
                                    Welcome back, {firstName}. Keep your
                                    momentum going.
                        ...
                        <section className="stats-grid">
                            <div className="stat-card accent">
                                ...
                                <div>
                                    ...
                                    <strong>
                                        {mins(todayAggregate.totalMinutes)}
                                    </strong>
                                    <small>
                                        <TrendingUp size={13} /> Completed
                                        sessions only
                                    </small>
                                </div>
                            </div>
                            ...
                            <div className="stat-card">
                                ...
                                <div>
                                    <span>Sessions</span>
                                    <strong>
                                        {todayAggregate.sessionCount}
                                    </strong>
                                    <small>
                                        Across{" "}
                                        {
                                            Object.keys(
                                                todayAggregate.byProject,
                                            ).length
                                        }{" "}
                                        project
                                        {Object.keys(todayAggregate.byProject)
                                            .length === 1
                                            ? ""
                                            : "s"}
                                    </small>
                            ...
                            <div className="timer-card">
                                ...
                                {targetReached && running && (
                                    <div
                                        ...
                                        role="status"
                                    >
                                        <Bell size={14} /> Daily target reached
                                        — overtime is still being counted.
                                    </div>
                                )}
                                {recoveryGap && (
                                    <div className="timer-recovery">
                                        ...
                                        <span>
                                            This gap is excluded. Resume only
            ...
            {editingLog && (
                <div className="modal-backdrop" role="presentation">
                    ...
                    >
                        ...
                        <h3>Edit session</h3>
                        <p>
                            Correct the project or report summary for this
                            completed session.
                        </p>
                        <label
                            className="modal-field"
                            htmlFor="edit-session-project"
                        >
                            PROJECT
                            <select
                        ...
                        {editError && (
                            <p className="sync-warning">{editError}</p>
                        )}
                ...
                <div className="modal-backdrop">
                    <div className="note-modal add-project-modal">
                        <button
                            className="modal-close"
                            onClick={() =>
                                !addingProject && setShowAddProject(false)
                            }
                        >
                            <X size={18} />
                        </button>
                        ...
                        <div className="modal-actions">
                            ...
                            <button
                                className="start-btn"
                                disabled={
                                    addingProject || !newProjectName.trim()
                                }
                                onClick={addProject}
                            >
            ...
            {editingLog && (
                <div className="modal-backdrop">
                    <div className="note-modal">
                        ...
                        <h3>Edit session</h3>
                        <p>
                            Correct the project or update the report summary for
                            this session.
                        </p>
                        <label
                            className="modal-field"
            ...
            {showNote && (
                <div className="modal-backdrop">
                    <div className="note-modal">
                        ...
                        <p>
                            Add detailed notes. We’ll create a concise 1–2 line
        ...
        <section className="sessions-card monthly-map">
            <div className="card-heading">
                ...
                <span className="muted">
                    {mins(Object.values(byDay).reduce((a, b) => a + b, 0))}{" "}
                    total
                </span>
            </div>
        ...
        <section className={`sessions-card${back ? " full-sessions" : ""}`}>
            <div className="card-heading">
                <div>
                    <h3>{title}</h3>
                    <p className="muted">
                        Your logged work sessions and notes.
                    </p>
                </div>
                {viewAll ? (
            ...
            <div className="session-summary-grid">
                ...
                <div>
                    ...
                    <strong>
                        {mins(
                            rows.length
                                ? Math.round(totalMinutes / rows.length)
                                : 0,
                        )}
                    </strong>
                </div>
