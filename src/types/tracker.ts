...
export interface FinanceTransaction { id: string; type: FinanceTransactionType; amount: number; accountId: string; toAccountId?: string | null; category: string; scope: "personal" | "business"; projectId?: string | null; date: string; description: string; reversalOf?: string | null; createdAt: Timestamp | null; }
