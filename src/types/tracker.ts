...
export interface FinanceAccount { id: string; name: string; kind: FinanceAccountKind; openingBalance: number; archived?: boolean; createdAt: Timestamp | null; }
export interface FinanceTransaction { id: string; type: FinanceTransactionType; amount: number; accountId: string; toAccountId?: string | null; category: string; scope: "personal" | "business"; projectId?: string | null; date: string; description: string; reversalOf?: string | null; recurringItemId?: string | null; createdAt: Timestamp | null; }
export interface FinanceAsset { id: string; name: string; type: "asset" | "liability"; value: number; note?: string; createdAt: Timestamp | null; }
export interface FinanceGoal { id: string; name: string; targetAmount: number; accountId?: string | null; createdAt: Timestamp | null; }
